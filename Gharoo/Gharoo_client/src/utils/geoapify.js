...
// This key is optional and public by design when supplied through Vite. Never
// keep a real provider key in source code: the primary reverse-geocoding path
// is the server-side Google endpoint.
export const GEOAPIFY_API_KEY = clientEnv.VITE_GEOAPIFY_API_KEY || ''
