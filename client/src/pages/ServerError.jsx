    ...
    <div className="auth-body">
      ...
      <main className="error-page">
        <section className="error-card">
          ...
          <div className="error-icon-wrap" aria-hidden="true"><i className="bi bi-tools"></i></div>
          <div className="error-code">500</div>
          <h1 className="h3 mb-2">Server Error</h1>
          <p className="text-muted mb-4">Something went wrong on our side. Please try again or return to the dashboard.</p>
